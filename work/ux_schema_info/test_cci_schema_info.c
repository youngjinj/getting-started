...
/*
 * The following problems occur because of classifying objects by schema.
 *
 *  1. Should the schema of the current session be used if the user does not specify a schema?
 *  2. Should the use of synonyms be allowed?
 *  3. 
 *
 */
...
#define TEST_CCI_SCH_QUERY_SPEC(user_name, class_name) \
  ...
  TEST_CCI_SCH_QUERY_SPEC ("user_1st", "view_1st"); /* expect 1 result. */

  TEST_CCI_SCH_QUERY_SPEC ("dba", "view_1st"); /* expect 1 or 2 result. */
  TEST_CCI_SCH_QUERY_SPEC ("dba", "user_2nd.view_1st"); /* expect 1 result. */
...
#define TEST_CCI_SCH_ATTRIBUTE_PATTERN(user_name, class_name, attr_name) \
  ...
  TEST_CCI_SCH_ATTRIBUTE_PATTERN ("user_1st", NULL, NULL); /* Skip too many results. */
...
#define TEST_CCI_SCH_CLASS_ATTRIBUTE(user_name, class_name, attr_name) \
  ...
  TEST_CCI_SCH_CLASS_ATTRIBUTE ("user_1st", NULL, NULL); /* Skip too many results. */
  ...
  TEST_CCI_SCH_CLASS_ATTRIBUTE ("dba", "table_1st", "column_1st");
...
#define TEST_CCI_SCH_CLASS_ATTRIBUTE_PATTERN(user_name, class_name, attr_name) \
  ...
  TEST_CCI_SCH_CLASS_ATTRIBUTE_PATTERN ("user_1st", NULL, NULL); /* Skip too many results. */
...
#define TEST_CCI_SCH_TRIGGER(user_name, class_name) \
  ...
  TEST_CCI_SCH_TRIGGER ("user_1st", "table_1st"); /* why can't it be found? */
...
#define TEST_CCI_SCH_TRIGGER_PATTERN(user_name, class_name) \
  ...
  TEST_CCI_SCH_TRIGGER_PATTERN ("user_1st", "table%"); /* why can't it be found? */
...
#define TEST_CCI_SCH_CLASS_PRIVILEGE_PATTERN(user_name, class_name) \
  ...
  TEST_CCI_SCH_CLASS_PRIVILEGE_PATTERN ("user_1st", "table%"); /* why can't it be found? */
...
#define TEST_CCI_SCH_ATTR_PRIVILEGE_PATTERN(user_name, class_name, attr_name) \
  ...
  TEST_CCI_SCH_ATTR_PRIVILEGE_PATTERN ("user_1st", "table_1st", "column%"); /* why can't it be found? */
...
#define TEST_CCI_SCH_DIRECT_SUPER_CLASS(user_name, class_name) \
  ...
  TEST_CCI_SCH_DIRECT_SUPER_CLASS ("dba", "table_5th");
...
#define TEST_CCI_SCH_DIRECT_SUPER_CLASS_PATTERN(user_name, class_name) \
  ...
  TEST_CCI_SCH_DIRECT_SUPER_CLASS_PATTERN ("user_1st", "table%"); /* why can't it be found? */
  TEST_CCI_SCH_DIRECT_SUPER_CLASS_PATTERN ("user_1st", "%\\_5%");
  TEST_CCI_SCH_DIRECT_SUPER_CLASS_PATTERN ("user_1st", "%5th");

  TEST_CCI_SCH_DIRECT_SUPER_CLASS_PATTERN ("dba", "table_5th");
