...
select v1.c1, v1.c2, v1.c3
from (
  (
    select v1.c1, v1.c2, v1.c3 from t1 v1 where (v1.c1= ?:1 )
    union all select v1.c1, v1.c2, v1.c3 from t2 v1 where (v1.c1= ?:2 )
  )
  union all select v1.c1, v1.c2, v1.c3 from t3 v1 where (v1.c1= ?:3 )
) v1 (c1, c2, c3)
