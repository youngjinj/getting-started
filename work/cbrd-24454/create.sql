...
grant select, insert, update, delete on table_1st to user_2nd;
grant select on table_2nd to user_2nd with grant option;
...
as select * from table_1st comment 'user_2nd > view_1st';

create view view_2nd (
    column_1st comment 'user_2nd > view_2nd > column_1st',
    column_2nd comment 'user_2nd > view_2nd > column_2nd'
  )
as select * from table_2nd comment 'user_2nd > view_2nd';
...
create table table_9th (
    ...
    column_2nd int references table_8th (column_1st) comment 'user_2nd > table_9th > column_2nd (fk)'
...
grant select, insert, update, delete on table_1st to user_4th;
grant select on table_2nd to user_4th with grant option;

create synonym synonym_1st for user_1st.table_1st;
create synonym synonym_2nd for user_1st.table_2nd;
